...
# Displays the results from the eclat function
results = list(rules)
print(results)
...
# Displays the results sorted by descending Support
desc_lift = resultsinDataFrame.nlargest(n=10, columns='Support')
print(desc_lift)
